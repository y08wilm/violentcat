...
public class Async {
    ...
    /* runs the loop asynchronously until it returns false */
    public static Promise async_loop_i(Supplier<Boolean> task) {
        final Promise promise = new Promise();
        final prop<IFunction<Integer>> functionProp = new prop<>();
    ...
    /* runs the loop asynchronously untill it returns false with an interval */
    public static Promise async_loop_i(Supplier<Boolean> task, long interval) {
        final Promise promise = new Promise();
        final prop<IFunction<Integer>> functionProp = new prop<>();
    ...
    /* runs the loop asynchronously untill it returns false with an interval with start delay (same as interval) */
    public static Promise async_loop_iw(Supplier<Boolean> task, long interval) {
        final Promise promise = new Promise();
        final prop<IFunction<Integer>> functionProp = new prop<>();
    ...
    /* runs the loop asynchronously untill it returns false with an interval and start delay */
    public static Promise async_loop_iw(Supplier<Boolean> task, long interval, long startAfter) {
        final Promise promise = new Promise();
        final prop<IFunction<Integer>> functionProp = new prop<>();
